...
/* Define to 1 if you have the `gnutls_cipher_encrypt' function. */
/* #undef HAVE_GNUTLS_CIPHER_ENCRYPT */
...
/* Define to 1 if you have the `udev_monitor_set_receive_buffer_size'
   function. */
#define HAVE_UDEV_MONITOR_SET_RECEIVE_BUFFER_SIZE 1
...
#define PACKAGE_STRING "libvirt 4.0.0"
...
/* whether gnutls >= 2.2.0 is available */
/* #undef WITH_GNUTLS */
